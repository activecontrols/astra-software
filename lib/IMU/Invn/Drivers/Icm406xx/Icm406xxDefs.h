...
int inv_icm406xx_wr_device_config_spi_mode(struct inv_icm406xx *s, ICM406XX_DEVICE_CONFIG_SPI_MODE_t new_value);
...
int inv_icm406xx_wr_device_config_reset(struct inv_icm406xx *s, ICM406XX_DEVICE_CONFIG_RESET_t new_value);
...
int inv_icm406xx_wr_int_cfg_int1_drive_circuit(struct inv_icm406xx *s, ICM406XX_INT_CONFIG_INT1_DRIVE_CIRCUIT_t new_value);
...
int inv_icm406xx_wr_int_cfg_int1_polarity(struct inv_icm406xx *s, ICM406XX_INT_CONFIG_INT1_POLARITY_t new_value);
...
int inv_icm406xx_wr_signal_path_rst_tmst_strobe(struct inv_icm406xx *s, ICM406XX_SIGNAL_PATH_RESET_TMST_STROBE_t new_value);
...
int inv_icm406xx_wr_signal_path_rst_fifo_flush(struct inv_icm406xx *s, ICM406XX_SIGNAL_PATH_RESET_FIFO_FLUSH_t new_value);
...
int inv_icm406xx_wr_intf_config0_fifo_sreg_invalid_ind(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG0_FIFO_SREG_INVALID_IND_t new_value);
...
int inv_icm406xx_wr_intf_config0_fifo_count_rec(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG0_FIFO_COUNT_REC_t new_value);
...
int inv_icm406xx_wr_intf_config0_fifo_count_endian(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG0_FIFO_COUNT_ENDIAN_t new_value);
...
int inv_icm406xx_wr_intf_config0_data_endian(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG0_DATA_COUNT_ENDIAN_t new_value);
int inv_icm406xx_rd_intf_config0_data_endian(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG0_DATA_COUNT_ENDIAN_t *value);
...
int inv_icm406xx_wr_intf_config0_spi_mode_ois2(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG0_SPI_MODE_OIS2_t new_value);
...
int inv_icm406xx_wr_intf_config0_spi_mode_ois1(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG0_SPI_MODE_OIS1_t new_value);
...
int inv_icm406xx_wr_intf_config1_accel_lp_clk_sel(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG1_ACCEL_LP_CLK_SEL_t new_value);
...
int inv_icm406xx_wr_pwr_mgmt0_gyro_mode(struct inv_icm406xx *s, ICM406XX_PWR_MGMT_0_GYRO_MODE_t new_value);
int inv_icm406xx_rd_pwr_mgmt0_gyro_mode(struct inv_icm406xx *s, ICM406XX_PWR_MGMT_0_GYRO_MODE_t *value);
...
int inv_icm406xx_wr_pwr_mgmt0_accel_mode(struct inv_icm406xx *s, ICM406XX_PWR_MGMT_0_ACCEL_MODE_t new_value);
int inv_icm406xx_rd_pwr_mgmt0_accel_mode(struct inv_icm406xx *s, ICM406XX_PWR_MGMT_0_ACCEL_MODE_t *value);
...
int inv_icm406xx_wr_gyro_config0_fs_sel(struct inv_icm406xx *s, ICM406XX_GYRO_CONFIG0_FS_SEL_t new_value);
int inv_icm406xx_rd_gyro_config0_fs_sel(struct inv_icm406xx *s, ICM406XX_GYRO_CONFIG0_FS_SEL_t *value);
...
int inv_icm406xx_wr_accel_config0_fs_sel(struct inv_icm406xx *s, ICM406XX_ACCEL_CONFIG0_FS_SEL_t new_value);
int inv_icm406xx_rd_accel_config0_fs_sel(struct inv_icm406xx *s, ICM406XX_ACCEL_CONFIG0_FS_SEL_t *value);
...
int inv_icm406xx_wr_accel_config0_odr(struct inv_icm406xx *s, ICM406XX_ACCEL_CONFIG0_ODR_t new_value);
...
int inv_icm406xx_wr_gyro_config1_avg_filt_rate(struct inv_icm406xx *s, ICM406XX_GYRO_CONFIG1_AVG_FILT_RATE_t new_value);
...
int inv_icm406xx_wr_gyro_accel_config0_accel_filt_bw(struct inv_icm406xx *s, ICM406XX_GYRO_ACCEL_CONFIG0_ACCEL_FILT_BW_t new_value);
int inv_icm406xx_rd_gyro_accel_config0_accel_filt_bw(struct inv_icm406xx *s, ICM406XX_GYRO_ACCEL_CONFIG0_ACCEL_FILT_BW_t *value);
...
int inv_icm406xx_wr_gyro_accel_config0_accel_filt_avg(struct inv_icm406xx *s, ICM406XX_GYRO_ACCEL_CONFIG0_ACCEL_FILT_AVG_t new_value);
int inv_icm406xx_rd_gyro_accel_config0_accel_filt_avg(struct inv_icm406xx *s, ICM406XX_GYRO_ACCEL_CONFIG0_ACCEL_FILT_AVG_t *value);
...
int inv_icm406xx_wr_gyro_accel_config0_gyro_filt_bw(struct inv_icm406xx *s, ICM406XX_GYRO_ACCEL_CONFIG0_GYRO_FILT_BW_t new_value);
int inv_icm406xx_rd_gyro_accel_config0_gyro_filt_bw(struct inv_icm406xx *s, ICM406XX_GYRO_ACCEL_CONFIG0_GYRO_FILT_BW_t *value);
...
int inv_icm406xx_wr_gyro_accel_config0_gyro_filt_avg(struct inv_icm406xx *s, ICM406XX_GYRO_ACCEL_CONFIG0_GYRO_FILT_AVG_t new_value);
...
int inv_icm406xx_wr_accel_config1_avg_filt_rate(struct inv_icm406xx *s, ICM406XX_ACCEL_CONFIG1_AVG_FILT_RATE_t new_value);
int inv_icm406xx_rd_accel_config1_avg_filt_rate(struct inv_icm406xx *s, ICM406XX_ACCEL_CONFIG1_AVG_FILT_RATE_t *value);
...
int inv_icm406xx_wr_smd_config_wom_int_mode(struct inv_icm406xx *s, ICM406XX_SMD_CONFIG_WOM_INT_MODE_t new_value);
int inv_icm406xx_rd_smd_config_wom_int_mode(struct inv_icm406xx *s, ICM406XX_SMD_CONFIG_WOM_INT_MODE_t *value);
...
int inv_icm406xx_wr_smd_config_wom_mode(struct inv_icm406xx *s, ICM406XX_SMD_CONFIG_WOM_MODE_t new_value);
int inv_icm406xx_rd_smd_config_wom_mode(struct inv_icm406xx *s, ICM406XX_SMD_CONFIG_WOM_MODE_t *value);
...
int inv_icm406xx_wr_smd_config_smd_mode(struct inv_icm406xx *s, ICM406XX_SMD_CONFIG_SMD_MODE_t new_value);
int inv_icm406xx_rd_smd_config_smd_mode(struct inv_icm406xx *s, ICM406XX_SMD_CONFIG_SMD_MODE_t *value);
...
int inv_icm406xx_wr_tmst_config_tmst_to_reg(struct inv_icm406xx *s, ICM406XX_TMST_CONFIG_TMST_TO_REGS_EN_t new_value);
...
int inv_icm406xx_wr_tmst_config_resolution(struct inv_icm406xx *s, ICM406XX_TMST_CONFIG_RESOL_t new_value);
...
int inv_icm406xx_wr_tmst_config_fsync_en(struct inv_icm406xx *s, ICM406XX_TMST_CONFIG_TMST_FSYNC_EN_t new_value);
int inv_icm406xx_rd_tmst_config_fsync_en(struct inv_icm406xx *s, ICM406XX_TMST_CONFIG_TMST_FSYNC_EN_t *value);
...
int inv_icm406xx_wr_fifo_config1_wm_gt_th(struct inv_icm406xx *s, ICM406XX_FIFO_CONFIG1_WM_GT_t new_value);
...
int inv_icm406xx_wr_fifo_config1_hires(struct inv_icm406xx *s, ICM406XX_FIFO_CONFIG1_HIRES_t new_value);
...
int inv_icm406xx_wr_fifo_config1_tmst_fsync(struct inv_icm406xx *s, ICM406XX_FIFO_CONFIG1_TMST_FSYNC_t new_value);
...
int inv_icm406xx_wr_fifo_config1_temp_en(struct inv_icm406xx *s, ICM406XX_FIFO_CONFIG1_TEMP_t new_value);
...
int inv_icm406xx_wr_fifo_config1_gyro_en(struct inv_icm406xx *s, ICM406XX_FIFO_CONFIG1_GYRO_t new_value);
...
int inv_icm406xx_wr_fifo_config1_accel_en(struct inv_icm406xx *s, ICM406XX_FIFO_CONFIG1_ACCEL_t new_value);
...
int inv_icm406xx_fsync_config_ui_sel(struct inv_icm406xx *s, ICM406XX_FSYNC_CONFIG_UI_SEL_t new_value);
...
int inv_icm406xx_wr_int_config1_asy_rst_dis(struct inv_icm406xx *s, ICM406XX_INT_CONFIG1_ASY_RST_t new_value);
...
int inv_icm406xx_wr_intf_config4_aux_spi(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG4_AUX_SPI_t new_value);
int inv_icm406xx_rd_intf_config4_aux_spi(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG4_AUX_SPI_t *value);
...
int inv_icm406xx_wr_intf_config4_ap_spi(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG4_AP_SPI_t new_value);
int inv_icm406xx_rd_intf_config4_ap_spi(struct inv_icm406xx *s, ICM406XX_INTF_CONFIG4_AP_SPI_t *value);
...
int inv_icm406xx_wr_ois1_config1_gyro_en(struct inv_icm406xx *s, ICM406XX_OIS1_CONFIG1_GYRO_EN_t new_value);
...
int inv_icm406xx_wr_ois1_config2_gyro_fs_sel(struct inv_icm406xx *s, ICM406XX_OIS1_CONFIG2_GYRO_FS_SEL_t new_value);
int inv_icm406xx_rd_ois1_config2_gyro_fs_sel(struct inv_icm406xx *s, ICM406XX_OIS1_CONFIG2_GYRO_FS_SEL_t *value);
...
int inv_icm406xx_wr_ois2_config1_gyro_en(struct inv_icm406xx *s, ICM406XX_OIS2_CONFIG1_GYRO_EN_t new_value);
...
int inv_icm406xx_wr_ois2_config2_gyro_fs_sel(struct inv_icm406xx *s, ICM406XX_OIS2_CONFIG2_GYRO_FS_SEL_t new_value);
int inv_icm406xx_rd_ois2_config2_gyro_fs_sel(struct inv_icm406xx *s, ICM406XX_OIS2_CONFIG2_GYRO_FS_SEL_t *value);
