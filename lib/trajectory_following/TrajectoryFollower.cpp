...
void follow_trajectory() {
  ...
  while (true) {
    ...
    has_left_ground = false; // has_left_ground | (TrajectoryLoader::trajectory[i].up > 0);
    ...
    ci.target_pos_north = 0; // TrajectoryLoader::trajectory[i].north;
    ci.target_pos_west = 0;  // TrajectoryLoader::trajectory[i].west;
    ci.target_pos_up = 0;    // TrajectoryLoader::trajectory[i].up;
